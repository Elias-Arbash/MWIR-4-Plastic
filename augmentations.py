...
# def spectral_interpolation(image):
#     """
#     Description: Interpolate between bands to create synthetic bands.
#     Purpose: Augments the spectral resolution.
#     """
#     new_image = np.zeros((image.shape[0], image.shape[1], image.shape[2] * 2 - 1))
#     new_image[:, :, ::2] = image
#     new_image[:, :, 1::2] = (image[:, :, :-1] + image[:, :, 1:]) / 2
#     return new_image
